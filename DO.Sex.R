...
#do.sex <- function(genotype, Nmothers, Nfathers, Noff, pop, F1, F2 = No, BC = Yes){
 ...
 # do.sex <- function(genotype, Nmothers, Nfathers, out.name){ 
...
for(i in 1:max(Nfamilies$Family)){ ## get families within population
  ...
  mom.who.bangs <- F1.family.make[get.mom.who.bangs,]
  dad.who.bangs <- F1.family.make[(max(Nfamilies$Moth)+get.dad.who.bangs),]
...
for(i in 1:max(Nfamilies$Family)){ ## get families within population
  ...
  mom.who.bangs <- F2.family.make[get.mom.who.bangs,]
  dad.who.bangs <- F2.family.make[(max(Nfamilies$Moth)+get.dad.who.bangs),]
...
for(i in 1:max(Nfamilies$Family)){ ## get families within population
  ...
  mom.who.bangs <- BC.family.make[get.mom.who.bangs,]
  dad.who.bangs <- BC.family.make[(max(Nfamilies$Moth)+get.dad.who.bangs),]
